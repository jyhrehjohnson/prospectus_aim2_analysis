...
cat("Tips:", Ntip(hominin_tree), "  Internal nodes:", Nnode(hominin_tree, "\n"))
...
# ============================================================
```{r}
disc_trait_names <- c("sagittal_crest", "malar_notch","nasal_sill", "supraorbital_torus")
...
for (taxon in hominin_tree$tip.label) {
  ...
  #Continuous traits: multivariate (rmvnorm) + sexual dimorphism
